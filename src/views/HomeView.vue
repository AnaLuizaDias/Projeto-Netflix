...
export default {
      ...
      filmes: [
        {
          ...
          imagem: new URL("@/assets/images/orgulho2.jpg", import.meta.url).href,
        },
        {
          id: 2,
      ...
      series: [
        {
          ...
          imagem: new URL("@/assets/images/bb1.jpg", import.meta.url).href,
        },
        {
          id: 7,
          nome: "Jogos Vorazes",
  ...
  methods: {
    comprarLivro(livro) {
      alert("Você adicionou " + livro.nome + " na sacola");
    },
  },
};
</script>
